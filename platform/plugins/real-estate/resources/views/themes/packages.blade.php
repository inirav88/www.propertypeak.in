@php
    ...
    Theme::set('pageTitle', __('Packages & Pricing'));
@endphp
...
<section class="flat-section flat-pricing">
    <div class="container">
        ...
        <!-- Tabs Navigation -->
        <div class="flat-tab-recommended mt-4">
            <ul class="nav-tab-recommended justify-content-center" id="pricingTab" role="tablist">
                <li class="nav-tab-item" role="presentation">
                    <button class="nav-link-item active" id="builders-tab" data-bs-toggle="pill"
                        data-bs-target="#builders" type="button" role="tab">{{ __('For Builders') }}</button>
                </li>
                <li class="nav-tab-item" role="presentation">
                    <button class="nav-link-item" id="agents-tab" data-bs-toggle="pill"
                        data-bs-target="#agents" type="button" role="tab">{{ __('For Agents') }}</button>
                </li>
                <li class="nav-tab-item" role="presentation">
                    <button class="nav-link-item" id="owners-tab" data-bs-toggle="pill"
                        data-bs-target="#owners" type="button" role="tab">{{ __('For Owners') }}</button>
                </li>
                <li class="nav-tab-item" role="presentation">
                    <button class="nav-link-item" id="addons-tab" data-bs-toggle="pill"
                                ...
                                <div class="card h-100 border-0 shadow-sm addon-card hover-up">
                                    <div class="card-body p-4 d-flex flex-column">
                                        <div class="d-flex justify-content-between align-items-center mb-3">
                                            ...
                                            <span class="badge bg-secondary-light text-secondary">{{ format_price($package->price) }}</span>
                                        </div>
                                        ...
                                        @endif
                                        <div class="mt-auto">
                                            <a href="{{ route('public.account.packages') }}" class="tf-btn w-100">{{ __('Add to Plan') }}</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
