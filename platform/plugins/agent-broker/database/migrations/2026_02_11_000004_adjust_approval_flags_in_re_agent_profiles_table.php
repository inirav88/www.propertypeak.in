...
return new class () extends Migration {
    ...
    {
        Schema::table('re_agent_profiles', function (Blueprint $table): void {
            if (Schema::hasColumn('re_agent_profiles', 'auto_approve')) {
                $table->dropColumn('auto_approve');
            }

            if (Schema::hasColumn('re_agent_profiles', 'requires_approval')) {
