...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Manage Developers</h1>
        <a href="{{ route('admin.developers.pending') }}" class="btn btn-warning">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form action="{{ route('admin.developers.index') }}" method="GET" class="row g-3">
                <div class="col-md-4">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img src="{{ $developer->logo_url }}" alt="" class="rounded" width="40" height="40">
                                        <div class="ms-3">
                                            <h6 class="mb-0">{{ $developer->company_name }}</h6>
                                            <small class="text-muted">{{ $developer->rera_id ?? 'No RERA' }}</small>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                ...
                                <td>{{ $developer->total_projects }}</td>
                                <td>
                                    @php
                                        $userStatus = $developer->user->status;
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{ route('admin.developers.show', $developer->id) }}" class="btn btn-sm btn-outline-primary">
                                            View
                                        </a>
