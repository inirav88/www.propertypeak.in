...
@section('title', 'Statistics - Developer Dashboard')
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0">{{ $stats['approved_properties'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <h3 class="mb-0">{{ $stats['pending_properties'] ?? 0 }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-4">
                            <div class="p-3">
                                <div class="display-4 text-success">{{ $stats['completed_projects'] ?? 0 }}</div>
                                <small class="text-muted">Completed</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="p-3">
                                <div class="display-4 text-warning">{{ $stats['ongoing_projects'] ?? 0 }}</div>
                                <small class="text-muted">Ongoing</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="p-3">
                                <div class="display-4 text-secondary">{{ $developer->upcoming_projects ?? 0 }}</div>
