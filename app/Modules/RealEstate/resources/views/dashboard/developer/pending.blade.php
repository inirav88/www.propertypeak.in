            ...
            <div class="card border-0 shadow">
                <div class="card-body p-5">
                    ...
                    <p class="text-muted mb-4">
                        Your developer account is currently under review. Our admin team will verify your information and approve your account shortly.
                    </p>
                    ...
                    <div class="alert alert-info" role="alert">
                        ...
                        <ul class="list-unstyled mb-0 text-start">
                            ...
                            <li><i class="fas fa-check text-success me-2"></i>You can then start adding projects and properties</li>
                        </ul>
                    </div>
