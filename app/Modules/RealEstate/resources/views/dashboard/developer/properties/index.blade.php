...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('developer-portal.properties.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach($properties as $property)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('developer-portal.properties.edit', $property->slug) }}" class="btn btn-sm btn-outline-primary">
                                            Edit
                                        </a>
                                    </td>
                                </tr>
