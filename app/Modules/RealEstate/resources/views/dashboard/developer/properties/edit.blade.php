...
@section('title', 'Edit Property - Developer Dashboard')
...
<div class="container-fluid py-4">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body">
            <form action="{{ route('developer-portal.properties.update', $property->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="developer_project_id" class="form-select @error('developer_project_id') is-invalid @enderror">
                            ...
                            @foreach($projects as $id => $name)
                                <option value="{{ $id }}" {{ old('developer_project_id', $property->developer_project_id) == $id ? 'selected' : '' }}>{{ $name }}</option>
                            @endforeach
                        </select>
