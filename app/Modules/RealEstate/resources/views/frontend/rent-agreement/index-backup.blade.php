        ...
        <form action="{{ route('rent-agreement.save') }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="widget-box bg-white mb-4" style="border: 3px solid #db1d23; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(219, 29, 35, 0.3);">
                        <div style="background: #db1d23; padding: 20px; border-bottom: 3px solid #b91c22;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="landlord_address" class="form-control @error('landlord_address') is-invalid @enderror" 
                                              rows="3" placeholder="House No, Street, Area, City" required style="border-radius: 8px;">{{ old('landlord_address') }}</textarea>
                                </div>
                                <div class="col-md-6 mb-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="widget-box bg-white mb-4" style="border: 3px solid #28a745; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(40, 167, 69, 0.3);">
                        <div style="background: #28a745; padding: 20px; border-bottom: 3px solid #1e7e34;">
                            <h5 style="color: white; margin: 0; display: flex; align-items: center; gap: 10px;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="tenant_address" class="form-control @error('tenant_address') is-invalid @enderror" 
                                              rows="3" placeholder="House No, Street, Area, City" required style="border-radius: 8px;">{{ old('tenant_address') }}</textarea>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label style="font-weight: 600; color: #333; margin-bottom: 8px; display: block;">{{ __('State') }} <span class="text-danger">*</span></label>
                                    <div class="select-wrapper">
            ...
            <!-- Property Details -->
            <div class="widget-box bg-white mb-4" style="border: 3px solid #6c757d; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(108, 117, 125, 0.3);">
                <div style="background: #6c757d; padding: 20px; border-bottom: 3px solid #495057;">
                    <h5 style="color: white; margin: 0; display: flex; align-items: center; gap: 10px;">
            ...
            <!-- Agreement Terms -->
            <div class="widget-box bg-white mb-4" style="border: 3px solid #17a2b8; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 15px rgba(23, 162, 184, 0.3);">
                <div style="background: #17a2b8; padding: 20px; border-bottom: 3px solid #138496;">
                    <h5 style="color: white; margin: 0; display: flex; align-items: center; gap: 10px;">
            ...
            <!-- Submit Button -->
            <div class="text-center mb-5">
                <button type="submit" class="tf-btn primary" style="min-width: 280px; height: 56px; font-size: 16px;">
                    <x-core::icon name="ti ti-eye" /> {{ __('Preview Agreement') }}
                </button>
            </div>
        </form>
